...
export function LeaveManagementContent() {
    ...
    return (
        <div
            className={`flex flex-col gap-6 p-4 md:p-6 bg-[#0A0A0A] ${selectedRequest ? 'overflow-hidden' : ''
                }`}
        >
            ...
            {/* Stats Grid */}
            <div
                className={`${selectedRequest ? 'filter blur-sm transition-all duration-200' : ''
                    }`}
            >
