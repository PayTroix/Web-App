/**
 * PendingRequest Widgets
 * Displays pending salary advancement requests and payroll volume
 */
...
const formatTokenAmount = (value: number): string => {
  try {
    ...
    const formattedAmount = formatUnits(value.toString(), 6);
...
export function PendingRequest({ count = 0 }: PendingRequestProps) {
  return (
...
export function PendingPayrollVolume({ volume = 0 }: PendingPayrollVolumeProps) {
